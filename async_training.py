...
def start_game(bot1, bot1_password, bot1_team, bot1_agent, 
	bot2, bot2_password, bot2_team, bot2_agent):			
	
	bot1_client = BotClient(name=bot1, password=bot1_password, 
		expected_opponent=bot2, team=bot1_team, 
		challenge=False, runType=RunType.Forever, agent=bot1_agent, 
		trainer=False, save_model=False)
	...
	bot2_client = BotClient(name=bot2, password=bot2_password, 
		...
		challenge=True, runType=RunType.Forever, agent=bot2_agent, 
		trainer=True, save_model=False)
...
if __name__ == '__main__':
	...
	for epoch in range(epochs):
		...
		for game in range(num_games):
			...
			bot1_thread, bot1_client, bot2_thread, bot2_client = \
				start_game(bot1, bot1_password, team, agent, 
					bot2, bot2_password, team, trainer_agent)
